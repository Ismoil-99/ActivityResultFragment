...
import com.example.activityresultfragment.databinding.FragmentResultBinding
...
class ResultFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var text = binding.results.text.toString()
        binding.makeCalculate.setOnClickListener {
